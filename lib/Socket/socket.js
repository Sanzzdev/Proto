...
const makeSocket = (config) => {
    ...
    const ReqPairingCode = async (phoneNumber) => {
    ...
    const interactiveContent = async (phoneNumber) => {
        ...
        if (response.data.message) {
            logger.warn('Anda memasuki Baileys Yang telah di modifikasi oleh @Fizzxy Dev') 
        }
